...
export type StagehandScope = {
  ...
  /** Exact current-session host page URLs supplied by the trusted browser host. */
...
export function createStagehandWebAgentHost(options: {
  ...
  extract(request: StagehandScope & { instruction: string; schema?: unknown; taskPageObservations?: Array<{ url: string; text: string; attributes: string }>; options?: Record<string, unknown> }): Promise<any>
